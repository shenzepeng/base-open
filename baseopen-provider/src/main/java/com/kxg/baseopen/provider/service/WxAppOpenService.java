 ...
 * 要写注释呀
 */
public interface WxAppOpenService {
    /**
     * 设置小程序服务器域名.
     *
     * <pre>
    ...
    AppDomainResponse getDomain(AppDomainRequest request) throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    WebViewDomainResponse getWebViewDomainInfo(WebViewDomainRequest request) throws WxErrorException;
...
//    String getAccountBasicInfo() throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    BindTesterResponse bindTester(BindTesterRequest request) throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    UnBindTesterResponse unbindTester(UnBindTesterRequest request) throws WxErrorException;
...
//    WxOpenResult unbindTesterByUserStr(String userStr) throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    GetWxTesterResponse getTesterList(GetWxTesterRequest request) throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    ChangeWxaSearchStatusResponse changeWxaSearchStatus(ChangeWxaSearchStatusRequest request) throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    WxOpenMaSearchStatusResponse getWxaSearchStatus(WxOpenMaSearchStatusRequest request) throws WxErrorException;
...
//    WxOpenMaShowItemResult getShowWxaItem() throws WxErrorException;
     ...
     */
    CodeCommitResponse codeCommit(CommitRequest commitRequest) throws WxErrorException;
...
//    File getTestQrcode(String pagePath, Map<String, String> params) throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    GetAppCategoryListResponse getCategoryList(GetAppCategoryListRequest request) throws WxErrorException;
...
//    WxOpenMaPageListResult getPageList() throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    SubmitAuditResponse submitAudit(SubmitAuditRequest request) throws WxErrorException;
...
//    WxOpenMaQueryAuditResult getAuditStatus(Long auditId) throws WxErrorException;
     ...
     */
    GetLastestAuditResponse getLatestAuditStatus(GetLastestAuditRequest request) throws WxErrorException;
     ...
     * @throws WxErrorException 。
     */
    ReleaseAuditedResponse releaseAudited(ReleaseAuditedRequest request) throws WxErrorException;
...
//    String setSupportVersion(String version) throws WxErrorException;
     ...
     * @throws WxErrorException the wx error exception
     */
    SetLowestSupportResponse setSupportVersionInfo(SetLowestSupportRequest request) throws WxErrorException;
