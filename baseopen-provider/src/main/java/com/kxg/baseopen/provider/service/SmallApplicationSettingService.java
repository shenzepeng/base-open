 ...
 *  小程序设置
 */
public interface SmallApplicationSettingService {
    /**
     ...
     */
    String MODIFY_DOMAIN_URL = "https://api.weixin.qq.com/wxa/modify_domain?access_token=";
    String SET_WEB_VIEW_DOMAIN_URL = "https://api.weixin.qq.com/wxa/setwebviewdomain?access_token=";
    /**
     ...
     */
    UpdateWxServerAddressResponse updateWxServiceAddress(UpdateWxServerAddressRequest updateWxServerAddressRequest) throws WxErrorException;
     ...
     * @throws WxErrorException 操作失败时抛出，具体错误码请看文档
     */
    SetWxUrlResponse setWebViewDomain(SetWxUrlRequest request) throws WxErrorException;
